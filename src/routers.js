...
import {Stack, Scene, Router, Actions, Modal,Lightbox} from 'react-native-router-flux';
            ...
            <Lightbox>
                <Stack key="root"  hideNavBar>
                    ...
                    <Stack back key="missionsstack" backButtonImage={Images.backButtonImg}>
                        ...
                        <Scene key="loadOperationalBrowseTask" component ={LoadOperationalBrowseTask} title="操作任务" titleStyle={styles.navigationBarTitleStyle}  rightTitle=" " onRight={() => {}} />
                    </Stack>
