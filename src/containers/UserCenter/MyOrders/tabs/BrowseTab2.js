...
class BrowseTab2 extends Component{
    constructor(props) {
        ...
        if(this.props.user) {
            ...
            this.props.getMemberTaskList(UserId, Token, 1, 20, 2, 2);
        }
    }
...
export default connect(mapStateToProps, {getPlatformLists, getMemberTaskList, initializeStatus})(BrowseTab2);
