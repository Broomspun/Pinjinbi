...
class AdvancedTab2 extends Component{
    constructor(props) {
        super(props);
        ...
        if(this.props.user) {
            ...
            this.props.getMemberTaskList(UserId, Token, 1, 20, 2, 1);
        }
    }
...
export default connect(mapStateToProps, {getPlatformLists, getMemberTaskList, initializeStatus})(AdvancedTab2);
