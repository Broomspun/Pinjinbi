...
class BeautifulMain extends Component {
            ...
            <Container style={{backgroundColor:Color.LightGrayColor}}>
                <Content style={{...Styles.mt15}}>
                    <View  style={{...Styles.RowCenterBetween, ...Styles.shadowStyle, backgroundColor: 'white', paddingHorizontal: 15, paddingVertical: 10}}>
                        <View style={{...Styles.RowCenterLeft}}>
                            <Image source={Images.beautiful_icon} style={{width: 20, height: 20, marginRight: 10}} />
                            <Text>最爱大法师</Text>
                        </View>
                        <View>
                ...
                <Footer>
                    <View style={{flex:1}}>
                        ...
                        <Button full style={{backgroundColor: 'white', height: 60}} onPress = {()=>Actions.bindBeautifulAccount()}>
...
export default connect(mapStateToProps, {})(BeautifulMain);
