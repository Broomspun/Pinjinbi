...
export const _renderOverlay = (completed)=>{
    if(completed)
        return (
            <View style={{
                flex: 1,
...
const MissionBlock = (props) => {
    const {point, goldValue, id, completed} = props;
    return (
        <View style={{backgroundColor: 'white'}}>
            <View style={{flex: 1, backgroundColor: 'white', marginTop: 10, paddingHorizontal: 15, paddingTop: 20, paddingBottom:10,borderColor: Color.Border, borderWidth: 1}}>
                <View style={{flex:1, flexDirection: 'row'}}>
                    ...
                    <View style={{flex:1}}>
                        <TouchableOpacity style={{borderRadius: 30, paddingVertical: 6, backgroundColor: Color.DarkLightBlue, alignSelf:'flex-end', paddingHorizontal: 15}}>
